...
// ACCEL 
// am(t) = a(t)_i + b(t) - [R](t)*g + n(t)

// GYRO
// wm(t)_i = w(t)_i + b(t) + n(t)

// PSD (Power Spectral Density)
// Sn = N*N + (B*B/2*pi*f) + (K*K/4*pi*pi*f*f)
// n(t) = nn(t) + nb(t) + nk(t) (white / pink / brown)

// ARW/VRW (nn(t))
// RRW (nk(t)) => b'(t) = nk(t) ~ N(0, K)
// BI

typedef struct imuCal{
    vec3 na;
    vec3 ba;
    vec3 ka;
...
typedef struct imuMeas{
    vec3 accel;
    vec3 gyro;
    double ts;
    Eigen::Cross<mat3,mat3> cross();
