...
\section{Arquitecturas de control}
    ...
    \begin{table}[H]
        ...
        \begin{tabularx}{0.896\textwidth}{|c|c|c|}
            ...
            \hline
            RRT & Eficiente en espacios de alta dimensionalidad. & Trayectoria subóptima. \\
            \hline
    ...
    características en imagen 2D y su integración en un esquema de VIO, capaz de corregir la deriva a una frecuencia inferior. Por otro
...
\section{Localización (VIO)}
    ...
    frente a desenfoque, oclusiones o falta de textura. Pueden distinguirse enfoques basados en filtrado y enfoques basados
