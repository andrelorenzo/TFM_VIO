...
Cuando se recibe una imagen RGB válida, el algoritmo selecciona e interpolá las medidas del acelerometro y giroscopio, generando así una secuencia de muestras 
...
Una vez localizado el intervalo, se calculaa el factor de interpolación lineal $\alpha$ y se obtiene la medida interpolada 
...
donde $v_x$, $v_y$ y $v_z$ representan las componentes de velocidad lineal, y $\omega_y$ corresponde a la velocidad angular 
