...
\chapter{Introducción}
    ...
    Se dispone del código fuente, ejemplos y procedimientos de instalación en un 
    \href{https://github.com/andrelorenzo/TFM_2dvision}{repositorio} público de GitHub.
\section{Motivación}
    ...
    A diferencia de otros vehículos autónomos, en este entorno la limitada disponibilidad de datos obliga a desarrollar soluciones optimizadas para la 
    ...
    un equilibrio adecuado entre coste computacional, fiabilidad y precisión. Es por ello que se propone explotar información visual 
...
\section{Objetivos del estudio}
    El objetivo principal de este trabajo es dotar a un UAV de pequeño tamaño de la capacidad de navegar de 
    forma autónoma en interiores. Para ello, el vehículo deberá ser capaz de desplazarse siguiendo una trayectoria previamente 
    ...
    \begin{itemize}
        ...
        \item \textbf{Referencia de validación:} Los resultados se validarán mediante información tridimensional capturada por la cámara de a bordo. Sin 
        embargo, dicha información no podrá emplearse en el algoritmo de navegación, utilizándose exclusivamente como referencia de validación. Aunque esta referencia resulta útil para comparar el comportamiento del sistema, no debe interpretarse como un \textit{ground truth} externo exacto. 
        ...
        trayectoria seguida por el vehículo, estimada y validada mediante las referencias disponibles durante los ensayos. En ningún tramo del recorrido dicha diferencia deberá superar los 1~m.
        ...
        con procesador Intel Core Ultra 7 y GPU NVIDIA GeForce RTX 2050. La cámara será una Intel RealSense D435i.
    \end{itemize}
\clearpage
\section{Estructura del trabajo}
    ...
    El cuarto capítulo se centra en el estudio e implementación de las comunicaciones y en la preparación de la recepción y el envío de datos.
    
    El quinto capítulo describe el desarrollo e integración de una solución VIO optimizada para el contexto del proyecto, detallando 
    su utilización como estimador de pose.

    El sexto capítulo analiza la viabilidad del uso de modelos de estimación de profundidad~\cite{estudio-nav2D}, 
    describiendo los modelos seleccionados, su arquitectura, las optimizaciones aplicadas y las métricas empleadas para la implementación.
    
    El séptimo capítulo describe las implementaciones del planificador local, del generador de trayectoria de referencia y del controlador.
