...
\section{Objetivos del estudio}
    ...
    fundamentales cuyo cumplimiento permitirá considerar satisfactoria la finalización del trabajo.
    ...
    \begin{itemize}
        ...
        seguridad equivalente al doble de la \textit{bounding box} del propio UAV.
