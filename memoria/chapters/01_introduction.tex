...
\section{Objetivos del estudio}
    ...
    \begin{itemize}
        ...
        \item \textbf{Ground truth:} Los resultados se validarán mediante información tridimensional capturada por la cámara de a bordo. Sin 
...
\section{Estructura del trabajo}
    ...
    El cuarto capítulo se centra en el estudio e implementación de las comuniaciones y preparación de recepción y envío de datos.
    ...
    su utilización estimador de posición.

    El sexto capítulo describe la de viabilidad del uso de modelos de estimación de profundidad~\cite{estudio-nav2D}, 
    ...
    El séptimo capítulo decribe las implementaciones de los planfiicadores locales y globales, además del desarrollo del controlador.
