...
\begin{figure}[H]
    \ffigbox[\FBwidth] {
        \caption[Arquitectura de la plataforma aérea]{Arquitectura de la plataforma aérea. Fuente: elaboración propia}
...
profundidad que, junto con un algoritmo de evitación de obstáculos, proporciona una dirección de movimiento segura.
    ...
    Toda esta información, junto con la trayectoria generada por el generador de trayectoria de referencia, se introduce en un planificador local. Este 
...
\begin{figure}[H]
    \ffigbox[\FBwidth] {
        \caption[Arquitectura de la estación de tierra]{Arquitectura de la estación de tierra. Fuente: elaboración propia}
...
\begin{figure}[H]
    \ffigbox[\FBwidth] {
        \caption[Controlador Orange Cube]{Controlador Orange Cube. Fuente: elaboración propia}
...
inerciales, lo que resulta especialmente adecuado para tareas de odometría visual-inercial y evitación de obstáculos.
...
\begin{figure}[H]
    \ffigbox[\FBwidth] {
        \caption[Cámara Intel RealSense D435i]{Cámara Intel RealSense D435i. Fuente:~\cite{zu2025d435i_figure}.}
        \label{fig:rs_435i}
    }
...
\begin{itemize}[nosep]
    ...
    \item Cámara RGB de $2~\mathrm{MP}$ con resolución de hasta $1920 \times 1080$ píxeles a $30~\text{FPS}$.
    \item Campo de visión del canal RGB de $69^\circ \times 42^\circ$.
    \item IMU Bosch BMI055 de 6 ejes, compuesta por acelerómetro y un giroscopio.
...
NVIDIA GeForce RTX 2050 donde se ejecuta el programa de navegación autónoma. El portátil se muestra en la Figura~\ref{fig:pc_est}.

\begin{figure}[H]
    \ffigbox[\FBwidth] {
        \caption[Portátil usado como estación de tierra]{Portátil usado como estación de tierra. Fuente:~\cite{hp_probook_440_g11}.}
        \label{fig:pc_est}
    }
    {\includegraphics[scale=0.15]{images/estacion_tierra_pc.png}}
\end{figure}
...
La transmisión del canal visual se realiza mediante un flujo RTSP, lo que permite transmitir vídeo en tiempo real desde la 
...
conceptualmente en el enfoque propuesto en R-VIO2~\cite{huai2022square} y~\cite{huai2024consistent}. Este módulo estima la pose relativa del UAV respecto al instante 
...
El sistema de planificación se divide en dos niveles. En primer lugar, un generador de trayectoria de referencia implementa una estrategia básica de 
tipo \textit{go-to}, encargada de interpolar una trayectoria de referencia a partir de los \textit{waypoints} definidos por el usuario. En 
...
vuelo mediante una comunicación UDP, cerrando así el ciclo de navegación.
