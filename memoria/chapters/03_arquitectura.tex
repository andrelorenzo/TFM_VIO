...
NVIDIA GeForce RTX 2050 donde se ejecuta el programa de navegación autónoma. El portatil se muestra en la Figura~\ref{fig:pc_est}

\begin{figure}[H]
    \ffigbox[\FBwidth] {
        \caption[Portatil usado como estación de tierra]{Portatil usado como estación de tierra.}
        \label{fig:pc_est}
    }
