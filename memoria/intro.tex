...
\setcounter{page}{3}
	...
	navegación autónoma y la evitación de obstáculos, limitando la captación de datos a una cámara monocular y una unidad de medida inercial 
	(IMU).
	...
	de obtener una estimación robusta del estado del dron y del entorno. Finalmente, la pose del vehículo se estima mediante un enfoque estadístico 
	...
	executed and fused with inertial information to obtain a robust estimate of both the UAV state and its surrounding environment. 
	...
	Monocular vision, OpenCV, ONNX, Depth Anything 3, Orange Cube, CUDA, autonomous navigation, obstacle avoidance, VIO, IMU
